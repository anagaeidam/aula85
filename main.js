...
function down()
{
    ...
    {
        roverY= roverY+ 10
        console.log("Quando a seta para baixo é precionada, x=" + roverX +"| y =" +roverY)
        uploadBackground();
        uploadRover();
    }
}
function left()
{
    ...
    {
        roverY = roverY - 10
        console.log ("Quando a seta para a esquerda é precionada, x=" + roverX +"| y =" +roverY);
        uploadBackground();
        uploadRover();
    }
}
function right()
{
    ...
    {
        roverY= roverY+ 10
        console.log("Quando a seta para a direita é precionada, x=" + roverX +"| y =" +roverY)
        uploadBackground();
        uploadRover();
    }
}